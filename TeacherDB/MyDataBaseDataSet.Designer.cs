...
namespace TeacherDB {
    ...
    public partial class MyDataBaseDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string Name, string Surname, string Group, System.DateTime DOB, string Phone, string Address, string Foto) {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_" +
                "Name) AND ([Surname] = @Original_Surname) AND ([Group] = @Original_Group) AND ([" +
                "DOB] = @Original_DOB) AND ([Phone] = @Original_Phone) AND ([Address] = @Original" +
                "_Address))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([Name], [Surname], [Group], [DOB], [Phone], [Address], [Foto]) VALUES (@Name, @Surname, @Group, @DOB, @Phone, @Address, @Foto);
SELECT Id, Name, Surname, [Group], DOB, Phone, Address, Foto FROM Student WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Surname] = @Surname, [Group] = @Group, [DOB] = @DOB, [Phone] = @Phone, [Address] = @Address, [Foto] = @Foto WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Group] = @Original_Group) AND ([DOB] = @Original_DOB) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address));
SELECT Id, Name, Surname, [Group], DOB, Phone, Address, Foto FROM Student WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Surname, [Group], DOB, Phone, Address, Foto FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Surname, string Original_Group, System.DateTime Original_DOB, string Original_Phone, string Original_Address) {
        ...
        public virtual int Insert(string Name, string Surname, string Group, System.DateTime DOB, string Phone, string Address, string Foto) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, string Group, System.DateTime DOB, string Phone, string Address, string Foto, int Original_Id, string Original_Name, string Original_Surname, string Original_Group, System.DateTime Original_DOB, string Original_Phone, string Original_Address, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Group, System.DateTime DOB, string Phone, string Address, string Foto, int Original_Id, string Original_Name, string Original_Surname, string Original_Group, System.DateTime Original_DOB, string Original_Phone, string Original_Address) {
            return this.Update(Name, Surname, Group, DOB, Phone, Address, Foto, Original_Id, Original_Name, Original_Surname, Original_Group, Original_DOB, Original_Phone, Original_Address, Original_Id);
        }
    }
